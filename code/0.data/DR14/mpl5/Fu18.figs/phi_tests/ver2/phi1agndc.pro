...
; 
; This version double counts binary AGNs
; 
; need to think about
; * binning issue
...
ba_ap = pnsa.ELPETRO_BA ; b/a axis ratio (0 < b/a < 1)
pa_ap = pnsa.ELPETRO_PHI ; PA (E of N) 
help,where(r_ap lt pcat.sep_arcsec) ; -1 
help,where(r_ap*ba_ap lt pcat.sep_arcsec) ; only 1
